...
select s.name
from student s
LEFT JOIN exam_management em on s.id = em.student_id AND em.subject_id = (
    select id from subject where name = 'Cơ sở dữ liệu'
)
